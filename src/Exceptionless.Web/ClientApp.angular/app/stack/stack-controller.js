            ...
            function (
                ...
                function addHotkeys() {
                    function logFeatureUsage(name) {
                        $ExceptionlessClient
                            .createFeatureUsage(vm._source + ".hotkeys" + name)
                            .addTags("hotkeys")
                            .submit();
                    }
                ...
                function addReferenceLink() {
                    ...
                    return dialogs
                        .create("app/stack/add-reference-dialog.tpl.html", "AddReferenceDialog as vm")
                        .result.then(function (url) {
                            function onSuccess() {
                                $ExceptionlessClient
                                    .createFeatureUsage(vm._source + ".addReferenceLink.success")
                                    .setProperty("url", url)
                                    .submit();
                            ...
                            function onFailure() {
                                $ExceptionlessClient
                                    .createFeatureUsage(vm._source + ".addReferenceLink.error")
                                    .setProperty("url", url)
                                    .submit();
                ...
                function getStats() {
                    ...
                    function optionsCallback(options) {
                        options.filter = ["stack:" + vm._stackId, options.filter]
                            .filter(function (f) {
                                return f && f.length > 0;
                            })
                            .join(" ");
                ...
                function hasSelectedChartOption() {
                    return (
                        vm.chartOptions.filter(function (o) {
                            return o.render && o.selected;
                        }).length > 0
                    );
                }
                ...
                function promoteToExternal() {
                    $ExceptionlessClient
                        .createFeatureUsage(vm._source + ".promoteToExternal")
                    ...
                    function onSuccess() {
                        $ExceptionlessClient
                            .createFeatureUsage(vm._source + ".promoteToExternal.success")
                            .setProperty("id", vm._stackId)
                            .submit();
                    ...
                    function onFailure(response) {
                        $ExceptionlessClient
                            .createFeatureUsage(vm._source + ".promoteToExternal.error")
                            .setProperty("id", vm._stackId)
                ...
                function removeReferenceLink(reference) {
                    $ExceptionlessClient
                        .createFeatureUsage(vm._source + ".removeReferenceLink")
                        .setProperty("id", vm._stackId)
                        .submit();
                    return dialogService
                        .confirmDanger(
                        ...
                        .then(function () {
                            function onSuccess() {
                                $ExceptionlessClient
                                    .createFeatureUsage(vm._source + ".removeReferenceLink.success")
                                    .setProperty("id", vm._stackId)
                                    .submit();
                            }
                            ...
                            function onFailure(response) {
                                $ExceptionlessClient
                                    .createFeatureUsage(vm._source + ".removeReferenceLink.error")
                                    .setProperty("id", vm._stackId)
                                    .setProperty("response", response)
                                    .submit();
                ...
                function remove() {
                    $ExceptionlessClient
                        .createFeatureUsage(vm._source + ".remove")
                        .setProperty("id", vm._stackId)
                        .submit();
                    var message = translateService.T(
                    ...
                    return dialogService
                        ...
                        .then(function () {
                            ...
                            function onFailure(response) {
                                $ExceptionlessClient
                                    .createFeatureUsage(vm._source + ".remove.error")
                                    .setProperty("id", vm._stackId)
                                    .setProperty("response", response)
                                    .submit();
                                notificationService.error(
                ...
                function updateOpen() {
                    function onSuccess() {
                        $ExceptionlessClient
                            .createFeatureUsage(vm._source + ".updateOpen.success")
                            .setProperty("id", vm._stackId)
                            .submit();
                    }
                    ...
                    function onFailure(response) {
                        $ExceptionlessClient
                            .createFeatureUsage(vm._source + ".updateOpen.error")
                            .setProperty("id", vm._stackId)
                            .setProperty("response", response)
                            .submit();
                        notificationService.error(
                    ...
                    $ExceptionlessClient
                        .createFeatureUsage(vm._source + ".updateOpen")
                        .setProperty("id", vm._stackId)
                        .submit();
                ...
                function updateCritical() {
                    function onSuccess() {
                        $ExceptionlessClient
                            .createFeatureUsage(vm._source + ".updateCritical.success")
                            .setProperty("id", vm._stackId)
                            .submit();
                    }
                    ...
                    function onFailure(response) {
                        $ExceptionlessClient
                            .createFeatureUsage(vm._source + ".updateCritical.error")
                            .setProperty("id", vm._stackId)
                            .setProperty("response", response)
                            .submit();
                        notificationService.error(
                    ...
                    $ExceptionlessClient
                        .createFeatureUsage(vm._source + ".updateCritical")
                        .setProperty("id", vm._stackId)
                        .submit();
                ...
                function updateDiscard() {
                    ...
                    function onSuccess() {
                        $ExceptionlessClient
                            .createFeatureUsage(vm._source + ".updateDiscard.success")
                            .setProperty("id", vm._stackId)
                            .submit();
                    }
                    ...
                    function onFailure(response) {
                        $ExceptionlessClient
                            .createFeatureUsage(vm._source + ".updateDiscard.error")
                            .setProperty("id", vm._stackId)
                            .setProperty("response", response)
                            .submit();
                        notificationService.error(
                    ...
                    $ExceptionlessClient
                        .createFeatureUsage(vm._source + ".updateDiscard")
                        .setProperty("id", vm._stackId)
                        .submit();
                    var message =
                        translateService.T(
                ...
                function updateFixed(showSuccessNotification) {
                    ...
                    function onSuccess() {
                        $ExceptionlessClient
                            .createFeatureUsage(vm._source + ".updateFixed.success")
                            .setProperty("id", vm._stackId)
                            .submit();
                    ...
                    function onFailure(response) {
                        $ExceptionlessClient
                            .createFeatureUsage(vm._source + ".updateFixed.error")
                            .setProperty("id", vm._stackId)
                            .setProperty("response", response)
                            .submit();
                        notificationService.error(
                    ...
                    $ExceptionlessClient
                        .createFeatureUsage(vm._source + ".updateFixed")
                        .setProperty("id", vm._stackId)
                        .submit();
                    return stackDialogService
                        .markFixed()
                ...
                function updateSnooze(timePeriod) {
                    ...
                    function onSuccess() {
                        $ExceptionlessClient
                            .createFeatureUsage(vm._source + ".updateSnooze.success")
                            .setProperty("id", vm._stackId)
                            .submit();
                    }
                    ...
                    function onFailure(response) {
                        $ExceptionlessClient
                            .createFeatureUsage(vm._source + ".updateSnooze.error")
                            .setProperty("id", vm._stackId)
                            .setProperty("response", response)
                            .submit();
                        notificationService.error(
                    ...
                    $ExceptionlessClient
                        .createFeatureUsage(vm._source + ".updateSnooze")
                        .setProperty("id", vm._stackId)
                        .submit();
                ...
                function updateIgnore() {
                    function onSuccess() {
                        $ExceptionlessClient
                            .createFeatureUsage(vm._source + ".updateIgnore.success")
                            .setProperty("id", vm._stackId)
                            .submit();
                    }
                    ...
                    function onFailure(response) {
                        $ExceptionlessClient
                            .createFeatureUsage(vm._source + ".updateIgnore.error")
                            .setProperty("id", vm._stackId)
                            .setProperty("response", response)
                            .submit();
                        notificationService.error(
                    ...
                    $ExceptionlessClient
                        .createFeatureUsage(vm._source + ".updateIgnore")
                        .setProperty("id", vm._stackId)
                        .submit();
                ...
                function showAllTimeLastOccurrence() {
                    return (
                        showAllTimeFirstOccurrence() ||
                        !moment(vm.stats.last_occurrence).isSame(moment(vm.stack.last_occurrence))
                    );
                }

                function showAllTimeRow() {
                    return (
                        (vm.stack.first_occurrence && showAllTimeEvents()) ||
                        showAllTimeFirstOccurrence() ||
                        showAllTimeLastOccurrence()
                    );
                }
                ...
                this.$onInit = function $onInit() {
                                ...
                                render: function (args) {
                                    ...
                                    var formattedDate =
                                        date.hours() === 0 && date.minutes() === 0
                                            ? date.format(dateFormat || "ddd, MMM D, YYYY")
                                            : date.format(dateTimeFormat || "ddd, MMM D, YYYY h:mma");
                                    ...
                                    args.detail
                                        ...
                                        .forEach(function (d) {
                                            var swatch =
                                                ...
                                                d.series.color.replace("0.5", "1") +
                                                '"></span>';
                                            content +=
                                                swatch +
                                                $filter("number")(d.formattedYValue) +
                                                " " +
                                                d.series.name +
                                                "<br />";
                                        }, this);
                    ...
                    vm.chartOptions = [
                        {
                            name: translateService.T("Occurrences"),
                            field: "sum:count~1",
                            title: "",
                            selected: true,
                            render: false,
                        ...
                        {
                            name: translateService.T("Average Value"),
                            field: "avg:value",
                            title: translateService.T("The average of all event values"),
                            render: true,
                            menuName: translateService.T("Show Average Value"),
                        },
                        {
                            name: translateService.T("Value Sum"),
                            field: "sum:value",
                            title: translateService.T("The sum of all event values"),
                            render: true,
                            menuName: translateService.T("Show Value Sum"),
                        },
                    ];
                        ...
                        canRefresh: function canRefresh(events, data) {
                            if (data.type === "PersistentEvent") {
                                ...
                                return data.project_id
                                    ? vm.stack.project_id === data.project_id
                                    : vm.stack.organization_id === data.organization_id;
                            }
